...
//   void put<T>(String key, T value, StoreSerializer<T> serializer) {
//     final map = serializer.toMap(value);
//     _store.put(key, map);
//   }
...
//   void putAll<T>(Map<String, T> items, StoreSerializer<T> serializer) {
//     for (final entry in items.entries) {
//       final map = serializer.toMap(entry.value);
//       _store.put(entry.key, map);
//     }
//   }
